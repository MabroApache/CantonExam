        ...
        <el-tab-pane label="基本信息" name="info">
          <el-form :model="infoForm" :rules="infoRules" ref="infoFormRef" label-width="100px" style="max-width: 500px">
            ...
            <el-form-item label="部门">
              <el-select v-model="infoForm.departmentId" disabled placeholder="请选择部门" style="width: 100%">
...
const handleUpdateInfo = async () => {
  ...
  loading.value = true
  try {
    await creatorApi.update(infoForm.value)
...
const handleUpdatePassword = async () => {
  ...
  loading.value = true
  try {
    await creatorApi.updatePassword({
      id: userInfo.value.id,
