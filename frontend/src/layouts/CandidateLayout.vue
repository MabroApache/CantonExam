    ...
    <el-container>
      ...
      <el-aside v-if="!sidebarDisabled" width="200px" class="aside">
        ...
        <el-menu :default-active="activeMenu" router background-color="#304156" text-color="#bfcbd9" active-text-color="#409EFF">
          <el-menu-item index="/candidate/home">
            <el-icon><HomeFilled /></el-icon>
            <span>系统首页</span>
          </el-menu-item>
          <el-menu-item index="/candidate/exam">
            <el-icon><Calendar /></el-icon>
            <span>在线考试</span>
          </el-menu-item>
          <el-menu-item index="/candidate/score">
        ...
        <el-header v-if="!sidebarDisabled" class="header">
          <div class="header-left">
            <el-breadcrumb separator="/">
              <el-breadcrumb-item :to="{ path: '/candidate/home' }">首页</el-breadcrumb-item>
          ...
          <div class="header-right">
            <el-dropdown>
              <span class="user-info">
                ...
                <span class="username">{{ userInfo.name || '考生' }}</span>
              </span>
              <template #dropdown>
                <el-dropdown-menu>
